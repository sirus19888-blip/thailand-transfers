...
export default function BangkokToChiangMaiPage() {
  ...
  return (
    <RoutePageTemplate
      ...
      desktopDescription="Compare long-distance travel options from Bangkok to Chiang Mai, including train, bus and flight connections. Check departure point, travel time, baggage rules, overnight options and live partner prices before booking."
      mobileDescription="Compare train, bus and flight options from Bangkok to Chiang Mai. Check live schedules, departure points and baggage rules before booking."
