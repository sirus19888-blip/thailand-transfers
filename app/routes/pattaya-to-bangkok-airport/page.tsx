...
export const metadata: Metadata = {
  title: "Pattaya to Bangkok Airport Transfers | Taxi, Van & Bus",
  description:
...
const pattayaBangkokAirportOptions = [
  {
    id: "taxi",
    name: "Private Taxi",
    ...
    affiliateUrl: pattayaBangkokAirportAffiliateUrls.taxi,
  },
  {
    id: "van",
    name: "Shared Van",
    ...
    affiliateUrl: pattayaBangkokAirportAffiliateUrls.van,
  },
  {
    id: "bus",
    name: "Bus / Coach",
    ...
    affiliateUrl: pattayaBangkokAirportAffiliateUrls.bus,
  },
];
          ...
          <Container>
            <div className="max-w-3xl">
              ...
              <h1 className="text-3xl font-bold tracking-tight text-[#10201d] min-[390px]:text-4xl lg:text-6xl">
                Pattaya to Bangkok Airport transfers
              </h1>

              <p className="mt-5 text-base leading-7 text-slate-600 lg:text-lg lg:leading-8">
                Compare return transfer options from Pattaya to Bangkok
                Suvarnabhumi Airport (BKK). This route is popular for travelers
                heading back to the airport after a beach stay in Pattaya.
              </p>

              <div className="mt-7 flex flex-col gap-3 sm:flex-row">
                <AffiliateButton
                  href={pattayaBangkokAirportAffiliateUrl}
                  trackingId="click_12go_general_pattaya_bangkok_airport"
                >
          ...
          <Container>
            <div className="mb-6">
              ...
              <h2 className="text-2xl font-bold text-[#10201d] lg:text-3xl">
                Compare Pattaya to Bangkok Airport transfer options
              </h2>
            ...
            <div className="overflow-hidden rounded-[2rem] border border-[#e7e2d8] bg-white shadow-xl shadow-black/5">
              <table className="w-full text-left">
                ...
                <tbody>
                  {pattayaBangkokAirportOptions.map((option) => (
                    <tr
                      key={option.id}
      ...
      <div className="lg:hidden">
        <section className="min-h-screen bg-[#f8f4ec] px-5 py-10 text-[#10201d]">
          ...
          <p className="mt-4 text-sm leading-6 text-slate-600">
            Compare taxi, van and bus options from Pattaya to Bangkok
            Suvarnabhumi Airport. Always check live availability and pickup
