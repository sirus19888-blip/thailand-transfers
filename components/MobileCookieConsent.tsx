...
export function MobileCookieConsent() {
  ...
  return (
    <div className="fixed inset-x-3 bottom-[calc(0.75rem+env(safe-area-inset-bottom))] z-[60] grid grid-cols-[1fr_auto] items-center gap-2 rounded-[18px] border border-[#e7e2d8] bg-white p-2.5 shadow-2xl shadow-black/20 lg:hidden">
      <div>
